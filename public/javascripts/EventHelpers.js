 ...
 * Drop behave consistently among browsers
 *
...
var EventHelpers = new function () {
	 ...
	 * @author John Resig - http://ejohn.org/projects/flexible-javascripts-events/
	 * @param {Object} obj - a javascripts object.
	...
	/**
	 * Removes an event that is attached to a javascripts object.
	 *
	 * @author Scott Andrew - http://www.scottandrew.com/weblog/articles/cbs-events
	 * @author John Resig - http://ejohn.org/projects/flexible-javascripts-events/	 * @param {Object} obj - a javascripts object.
	...
	*/
	...
	function init() {
		...
		document.write('<script id="__ie_onload" defer src="' +
			((location.protocol == 'https:') ? '//0' : 'javascripts:void(0)') + '"><\/script>');
