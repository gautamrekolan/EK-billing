 ...
 *
 * This javascripts library contains helper routines to assist HTML5 Drag and
...
var DragDropHelpers = new function () {
	...
	function setEvents() {
		...
		if (draggableNodes.length > 0) {
			for (var i = 0; i < draggableNodes.length; i++) {
				 ...
				 * and make it transparent.  On dragend, it will destroy
				 * it.
				 */
				if (me.fixVisualCues) {
	 ...
	 * http://www.mediacollege.com/internet/javascripts/number/random.html
	 */
